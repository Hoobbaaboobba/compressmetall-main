...
const AdvantagesCard: React.FC<AdvantagesCardProps> = ({
    ...
    return (
        <Card className={`flex flex-col gap-2 relative ${big && "xl:items-end sm:justify-center"} cursor-pointer w-full h-full bg-white p-6 border-none hover:shadow-md hover:bg-white hover:border transition duration-500`}>
