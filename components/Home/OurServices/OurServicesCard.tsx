...
const OurServicesCard: React.FC<OurServicesCard> = ({
    ...
    return (
        <Link href={`/${pathname[1] || "moscow"}/services/${link}`} className="w-full hover:bg-white hover:shadow-md transition duration-300 flex flex-col bg-white rounded-lg gap-4 p-6">
