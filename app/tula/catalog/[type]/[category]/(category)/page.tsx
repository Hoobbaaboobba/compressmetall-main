...
export async function generateMetadata(
  ...
  return {
    title: `${products[0].metaType} ${products[0].title} Туле с доставкой по России | Купить ${products[0].metaType} в компании Компресс Металл`,
    ...
    keywords: [
      `${decodeURI(products[0].label)} в Туле оптом и в розницу`,
      `Компресс металл ${decodeURI(
        products[0].metaType
      )} в Туле оптом и в розницу`,
      `Купить ${decodeURI(products[0].metaType)} в Туле оптом и в розницу`,
      `Металлопрокат ${products[0].metaType} в Туле оптом и в розницу`,
      `Компресс металл ${products[0].metaType} в Туле оптом и в розницу`,
      `Купить ${decodeURI(products[0].label)} в Туле оптом и в розницу`,
    ...
    openGraph: {
      ...
      description: `${products[0].metaType}, ${products[0].title} по доступным ценам — ${products[0].metaType} в Туле от компании Компремм Металл. Заказать ${products[0].metaType} по выгодной цене с бесплатной доставкой по всей России и СНГ`,
      url: `https://kometal.ru/tula/catalog/${params.type}/${params.category}`,
