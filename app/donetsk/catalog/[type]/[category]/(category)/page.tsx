...
export async function generateMetadata(
  ...
  return {
    title: `${products[0].metaType} ${products[0].title} Донецке с доставкой по России | Купить ${products[0].metaType} в компании Компресс Металл`,
    ...
    keywords: [
      `${decodeURI(products[0].label)} в Донецке оптом и в розницу`,
    ...
    openGraph: {
      ...
      url: `https://kometal.ru/donetsk/catalog/${params.type}/${params.category}`,
