...
export async function generateMetadata(
  ...
  return {
    title: `${products[0].metaType} ${products[0].title} Москве с доставкой по России | Купить ${products[0].metaType} в компании Компресс Металл`,
    ...
    keywords: [
      `${decodeURI(products[0].label)} в Москве оптом и в розницу`,
      `Компресс металл ${decodeURI(
        products[0].metaType
      )} в Москве оптом и в розницу`,
      `Купить ${decodeURI(products[0].metaType)} в Москве оптом и в розницу`,
      `Металлопрокат ${products[0].metaType} в Москве оптом и в розницу`,
      `Компресс металл ${products[0].metaType} в Москве оптом и в розницу`,
      `Купить ${decodeURI(products[0].label)} в Москве оптом и в розницу`,
    ...
    openGraph: {
      ...
      url: `https://kometal.ru/moscow/catalog/${params.type}/${params.category}`,
