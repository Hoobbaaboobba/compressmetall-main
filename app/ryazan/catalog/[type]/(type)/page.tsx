...
export async function generateMetadata(
  ...
  return {
    title: `${decodeURI(categories[0].metaData)}, ${decodeURI(
      categories[0].label
    )} в Рязани с доставкой по России | Купить ${categories.map((item) =>
    ...
    openGraph: {
      ...
      description: `${categories[0].label}, ${categories[0].metaData} по доступным ценам — ${products[0].metaType} в Рязани от компании Компремм Металл. Заказать ${products[0].metaType} по выгодной цене с бесплатной доставкой по всей России и СНГ`,
