...
export async function generateMetadata(
  ...
  return {
    title: `${products[0].metaType} ${products[0].title} Рязани с доставкой по России | Купить ${products[0].metaType} в компании Компресс Металл`,
    ...
    openGraph: {
      ...
      url: `https://kometal.ru/ryazan/catalog/${params.type}/${params.category}`,
