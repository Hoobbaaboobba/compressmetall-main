...
export async function generateMetadata(
  ...
  return {
    title: `${products[0].metaType} ${products[0].title} Уфе с доставкой по России | Купить ${products[0].metaType} в компании Компресс Металл`,
    ...
    keywords: [
      `${decodeURI(products[0].label)} в Уфе оптом и в розницу`,
      `Компресс металл ${decodeURI(
        products[0].metaType
      )} в Уфе оптом и в розницу`,
      `Купить ${decodeURI(products[0].metaType)} в Уфе оптом и в розницу`,
      `Металлопрокат ${products[0].metaType} в Уфе оптом и в розницу`,
      `Компресс металл ${products[0].metaType} в Уфе оптом и в розницу`,
      `Купить ${decodeURI(products[0].label)} в Уфе оптом и в розницу`,
    ...
    openGraph: {
      ...
      url: `https://kometal.ru/ufa/catalog/${params.type}/${params.category}`,
