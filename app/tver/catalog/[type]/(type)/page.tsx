...
export async function generateMetadata(
  ...
  return {
    ...
    keywords: [
      ...
      `Купить ${decodeURI(categories[0].metaData)} в Твери оптом и в розницу`,
      `Металлопрокат ${categories[0].metaData} в Твери оптом и в розницу`,
      `Компресс металл ${categories[0].metaData} в Твери оптом и в розницу`,
      `Купить ${decodeURI(categories[0].metaData)} в Твери оптом и в розницу`,
