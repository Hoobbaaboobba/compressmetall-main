...
export async function generateMetadata(
  ...
  return {
    title: `${decodeURI(categories[0].metaData)}, ${decodeURI(
      categories[0].label
    )} в Казани с доставкой по России | Купить ${
      categories[0].label
    } в компании Компресс Металл`,
    description: `${categories[0].metaData} в Казани по доступным ценам — ${categories[0].metaData} в Казани от компании Компремм Металл. Заказать ${categories[0].metaData} по выгодной цене с бесплатной доставкой по всей России и СНГ`,
    keywords: [
      ...
      `Купить ${decodeURI(categories[0].metaData)} в Казани оптом и в розницу`,
      `Металлопрокат ${categories[0].metaData} в Казани оптом и в розницу`,
      `Компресс металл ${categories[0].metaData} в Казани оптом и в розницу`,
      `Купить ${decodeURI(categories[0].metaData)} в Казани оптом и в розницу`,
    ...
    openGraph: {
      ...
      description: `${categories[0].label}, ${categories[0].metaData} по доступным ценам — ${categories[0].metaData} в Казани от компании Компремм Металл. Заказать ${categories[0].metaData} по выгодной цене с бесплатной доставкой по всей России и СНГ`,
