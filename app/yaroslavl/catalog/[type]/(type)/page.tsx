...
export async function generateMetadata(
  ...
  return {
    title: `${decodeURI(categories[0].metaData)}, ${decodeURI(
      categories[0].label
    )} в Ярославле с доставкой по России | Купить ${
      categories[0].label
    } в компании Компресс Металл`,
    description: `${categories[0].metaData} в Ярославле по доступным ценам — ${categories[0].metaData} в Ярославле от компании Компремм Металл. Заказать ${categories[0].metaData} по выгодной цене с бесплатной доставкой по всей России и СНГ`,
    keywords: [
    ...
    openGraph: {
      ...
      description: `${categories[0].label}, ${categories[0].metaData} по доступным ценам — ${categories[0].metaData} в Ярославле от компании Компремм Металл. Заказать ${categories[0].metaData} по выгодной цене с бесплатной доставкой по всей России и СНГ`,
      url: `https://www.kometal.ru/yaroslavl/catalog/${params.type}/`,
